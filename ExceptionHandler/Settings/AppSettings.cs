    ...
    public class AppSettings
    {
        ...
        public static bool CommandLineHelpRequested
        {
            get
            {
                ...
                foreach (var strKey_loopVariable in _objCommandLineArgs.AllKeys)
                {
        ...
        public static string ConfigPath
        {
            get
            {
                ...
                {
                    _strConfigPath = Convert.ToString(AppDomain.CurrentDomain.GetData("APP_CONFIG_FILE"));
                }
        ...
        public static string AppBase
        {
            get
            {
                if (_strAppBase == null)
                {
                    _strAppBase = Convert.ToString(AppDomain.CurrentDomain.GetData("APPBASE"));
                }
                return _strAppBase;
            }
        }
        ...
        public static string SecurityZone
        {
            get
            {
                ...
                {
                    _strSecurityZone = Zone.CreateFromUrl(AppBase).SecurityZone.ToString();
                }
        ...
        private static NameValueCollection GetAssemblyAttribs()
        {
            ...
            foreach (var objAttributeLoopVariable in objAttributes)
            {
                var objAttribute = objAttributeLoopVariable;
            ...
            {
                throw new MissingFieldException("The AssemblyInfo file for the assembly " + objAssembly.GetName().Name +
                                                " must have the <Assembly:AssemblyProduct()> key populated.");
            }
            if (objNameValueCollection["Company"] == null)
            {
                throw new MissingFieldException("The AssemblyInfo file for the assembly " + objAssembly.GetName().Name +
                                                " must have the <Assembly: AssemblyCompany()>  key populated.");
            }
        ...
        private static bool GetKeyValueCommandLineArg(string strArg, ref NameValueCollection objNameValueCollection)
        {
            ...
            else
            {
                ...
                {
                    objMatch = objMatch_loopVariable;
                    objNameValueCollection.Add(RemoveArgPrefix(objMatch.Groups["Key"].ToString()),
        ...
        private static NameValueCollection GetCommandLineArgs()
        {
            ...
            if (strArgs.Length > 0)
            {
                ...
                string strArg = null;
                var intArg = 0;
                foreach (var strArg_loopVariable in strArgs)
                {
        ...
        {
            var strTemp = ConfigurationSettings.AppSettings.Get(key);
            if (strTemp == null)
            {
                return false;
            }
        ...
        {
            var strTemp = Convert.ToString(ConfigurationSettings.AppSettings.Get(key));
            if (strTemp == null)
            {
                return "";
            }
        ...
        {
            var intTemp = Convert.ToInt32(ConfigurationSettings.AppSettings.Get(key));
            if (intTemp == null)
            {
                return 0;
            }
